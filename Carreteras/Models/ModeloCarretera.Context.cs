...
namespace Carreteras.Models
{
    ...
    public partial class BD_CARRETERASEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> PA_Ciudades_Insertar(string ciuid, string ciudescripcion, string depid, string ciuusuariocrea, Nullable<System.DateTime> ciufechacrea, Nullable<bool> ciuestado)
        {
            var ciuidParameter = ciuid != null ?
                new ObjectParameter("ciuid", ciuid) :
                new ObjectParameter("ciuid", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PA_Ciudades_Insertar", ciuidParameter, ciudescripcionParameter, depidParameter, ciuusuariocreaParameter, ciufechacreaParameter, ciuestadoParameter);
        }
    
        public virtual ObjectResult<string> PA_CiudadesUpdate(string ciuid, string ciudescripcion, string depid, string ciuusuariomodifica, Nullable<System.DateTime> ciufechamodifica)
        {
            var ciuidParameter = ciuid != null ?
                new ObjectParameter("ciuid", ciuid) :
                new ObjectParameter("ciuid", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PA_CiudadesUpdate", ciuidParameter, ciudescripcionParameter, depidParameter, ciuusuariomodificaParameter, ciufechamodificaParameter);
        }
